...
final class NCBrandColor: @unchecked Sendable {
    ...
    ///
    let customer:              UIColor = UIColor(red: 5.0/255.0, green: 255.0/255.0, blue: 34.0/255.0, alpha: 1.0)
    var customerText:             UIColor = UIColor(red: 42.0/255.0, green: 39.0/255.0, blue: 180.0/255.0, alpha: 1.0)
