...
final class NCBrandOptions: @unchecked Sendable {
    ...
    var textCopyrightNextcloudiOS:       String = "IONOS HiDrive Next for iOS %@"
    var textCopyrightNextcloudServer:    String = "IONOS HiDrive Next Server %@"
    var loginBaseUrl:                    String = "https://prelive.storage.ionos.fr"
    ...
    var privacy: String = "https://privacy.ionos.de"
    ...
    // Capabilities Group
    var capabilitiesGroup:              String = "group.com.ionos.hidrivenext"
    var capabilitiesGroupApps:              String = "group.com.ionos.hidrivenext.apps"
...
final class NCBrandColor: @unchecked Sendable {
    ...
    ///
    let customer:              UIColor = UIColor(red: 0.0/255.0, green: 119.0/255.0, blue: 194.0/255.0, alpha: 1.0)
    var customerText:             UIColor = UIColor(red: 0.0/255.0, green: 27.0/255.0, blue: 65.0/255.0, alpha: 1.0)
